...
public class Player implements Bot {
    ...
    public void handleNewRound(GameState gameState, RoundState roundState, int active) {
        int myBankroll = gameState.bankroll; // the total number of chips you've gained or lost from the beginning of
                                             // the game to the start of this round
    ...
    public Action getAction(GameState gameState, RoundState roundState, int active) {
        ...
        int myPip = roundState.pips.get(active); // the number of chips you have contributed to the pot this round of
                                                 // betting
        int oppPip = roundState.pips.get(1 - active); // the number of chips your opponent has contributed to the pot
        ...
        int oppContribution = State.STARTING_STACK - oppStack; // the number of chips your opponent has contributed to
                                                               // the pot
